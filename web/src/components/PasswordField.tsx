...
export function PasswordField({ value, onChange, placeholder, palette }: Props) {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{ background: "none", border: "none", cursor: "pointer", color: palette.textSecondary, padding: 4, display: "flex" }}
      >
        {visible ? (
