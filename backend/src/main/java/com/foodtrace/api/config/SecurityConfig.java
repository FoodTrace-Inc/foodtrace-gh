...
public class SecurityConfig {
  ...
  SecurityFilterChain publicSecurityFilterChain(HttpSecurity http) throws Exception {
    return http
        .securityMatcher("/health", "/api/health", "/api", "/api/auth/roles", "/api/auth/register", "/api/auth/login", "/api/auth/request-otp", "/api/auth/verify-otp", "/api/auth/forgot-password", "/api/auth/reset-password", "/api/auth/security-question/lookup", "/api/auth/reset-with-security", "/api/auth/forgot-password/start", "/api/auth/forgot-password/verify-q1", "/api/auth/forgot-password/verify-q2", "/api/auth/forgot-password/reset", "/api/stats/**", "/api/assistant/**", "/api/ussd", "/api/sms/**", "/uploads/**", "/actuator/**", "/api/payments/webhook")
