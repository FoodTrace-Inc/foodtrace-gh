...
async function run() {
  ...
  try {
    ...
    const drugBatches = [
      { drugId: drugIds[0], pharmacyId: pharmacies[0].pharmacyId, batchNumber: "DB-1001", code: "DR-QR-1001", recallStatus: "active", imageUrl: null },
      { drugId: drugIds[2], pharmacyId: pharmacies[0].pharmacyId, batchNumber: "DB-2002", code: "DR-QR-2002", recallStatus: "active", imageUrl: null },
      { drugId: drugIds[3], pharmacyId: pharmacies[1].pharmacyId, batchNumber: "DB-4004", code: "DR-QR-4004", recallStatus: "recalled", recallReason: "Banned drug test batch.", imageUrl: null },
    ];
